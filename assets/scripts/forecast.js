...
// получение данных с домашней страницы и запись в переменные
...
function searchHandler() {
  ...
  if (city !== "") {
    ...
    // функция для выведения на страницу дополнительной информации о погоде
    ...
    // функция для выведения на страницу 5-дневого прогноза погоды
